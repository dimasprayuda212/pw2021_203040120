...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Mar 2021 pada 14.47
...
CREATE TABLE `barang` (
  ...
  `Stok Barang` varchar(500) NOT NULL,
...
INSERT INTO `barang` (`No`, `Nama Barang`, `Spesifikasi`, `Warna`, `Harga`, `Stok Barang`, `Foto`) VALUES
